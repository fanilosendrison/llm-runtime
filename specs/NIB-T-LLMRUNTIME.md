...
Ce document est la spécification de tests à implémenter **avant** toute ligne de code de production (étape RED du cycle TDD). Il matérialise le **contrat observable** de `@fanilosendrison/llm-runtime` : ce que le système doit faire, vu de l'extérieur.
...
*@fanilosendrison/llm-runtime — Implicit-Free Execution — "La fiabilité précède l'intelligence."*
